...
const setupApp = require("./web/main/config/app");
...
this.multiworld = {};
this.multiworld[1] = new GameServer(
  1,
  [86, "Normal", 0, 0],
  900,
  server,
...
this.multiworld[2] = new GameServer(
  2,
  [86, "Holiday", 1, 3],
  900,
  server,
...
this.multiworld[3] = new GameServer(
  3,
  [86, "Betting", 0, 0],
  900,
  server,
...
this.multiworld[4] = new GameServer(
  4,
  [86, "All", 0, 0],
  900,
  server,
...
this.multiworld[5] = new GameServer(
  5,
  [86, "Prix", 1, 3],
  900,
  server,
...
this.multiworld[6] = new GameServer(
  6,
  [86, "Bunge.", 1, 3],
  900,
  server,
...
this.multiworld[7] = new GameServer(
  7,
  [86, "Avatar On", 1, 3],
  900,
  server,
...
this.multiworld[8] = new GameServer(
  8,
  [86, "All", 0, 0],
  900,
  server,
...
this.multiworld[9] = new GameServer(
  9,
  [86, "Aduka", 1, 1],
  900,
  server,
...
this.multiworld[10] = new GameServer(
  10,
  [86, "On", 1, 3],
  900,
  server,
...
this.multiworld[11] = new GameServer(
  11,
  [86, "Off", 1, 3],
  900,
  server,
...
this.multiworld[12] = new GameServer(
  12,
  [86, "Prix", 1, 3],
  900,
  server,
