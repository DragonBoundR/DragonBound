...
//     Logger.log("getAvatar use detected with id: " + id);
//     var itm = [];
//     if (id !== 0) {
...
module.exports = class Player {
    constructor(data) {
        ...
        this.tournament = [
            this.tournament_start_time, this.tournament_end_time, 2, 0, 0, 10, "", 0, 0, 0, [25, 4, 40], 0, 1, 0, 1, 0, -10, false,
            [
                {
        ...
        this.loss = data.loss;
        this.win_rate = 100;
        let sumtotal = this.win + this.loss;
        if (sumtotal > 0) {
        ...
        this.megaphones = data.megaphones;
    ...
    resetStatsToDefault() {
        ...
        if (selectedMobile) {
            ...
            self.shield_regen = 0; // No shield regen
        }
