                    ...
                    conn.query('SELECT game_id, cash, IdAcc FROM users WHERE IdAcc = ?', [acc_id])
                        ...
                        if (rows4[0].length > 0) {
                            ...
                            res.render('pincode', {//rows_x2[0].
                                ...
                                user_by: '',
                                error_pin: '',
                                pin_code: '<div id="pin_box"><div id="pin_title">DangerBound PIN Card</div><div id="pin_code">BP10-2345-UVWX-3456</div><div id="pin_cash"><span class="yellow">10000 CASH</span></div><div id="pin_reseller">(By: DangerBound)</div><div class="red" id="pin_used">Used By: 1 - DangerBound</div></div>'
                            });
                        } else {
                            res.redirect('/pin');
                        }
                                                        ...
                                                        conn.query('SELECT game_id, cash, IdAcc FROM users WHERE IdAcc = ?', [acc_id])
                                                            ...
                                                            if (rows9[0].length > 0) {
                                                                ...
                                                                res.render('pincode', {
                                                                    ...
                                                                    user_by: '',
                                                                    error_pin: '',
                                                                    pin_code: '<div id="pin_box"><div id="pin_title">DangerBound PIN Card</div><div id="pin_code">'+rows_x3[0].pin+'</div><div id="pin_cash"><span class="yellow">'+cash_recived+' CASH</span></div><div id="pin_reseller">(By: '+rows_x3[0].seller+')</div><div class="red" id="pin_used">Used By: 1 - '+rows_x7[0].game_id+'</div></div>'
                                                                });
                                                            } else {
                                                                res.redirect('/pin');
                                                            }
